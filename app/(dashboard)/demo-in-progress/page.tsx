    ...
    <>
      ...
      <div className="w-full max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <CardHeader className="pb-4 sm:pb-6 w-full min-w-0">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-6 w-full min-w-0">
            <div className="shrink-0 flex-shrink-0">
              <DemoInProgressAnimated />
            </div>
            <div className="flex-1 text-center sm:text-left w-full min-w-0">
              <CardTitle className="text-xl sm:text-2xl break-words w-full">Votre démo est en cours de création ⚙️</CardTitle>
              <CardDescription className="mt-2 text-sm sm:text-base break-words w-full">
                Nous préparons votre site de démonstration personnalisé pour le projet{" "}
                <span className="font-semibold text-foreground break-words">{projectName}</span>.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4 sm:space-y-6 w-full min-w-0">
          <div className="rounded-xl border border-border/50 bg-muted/30 p-4 sm:rounded-2xl sm:p-6 w-full min-w-0">
            <h3 className="mb-3 text-base font-semibold text-foreground sm:mb-4 sm:text-lg break-words w-full">
              Que se passe-t-il maintenant ?
            </h3>
            <ul className="space-y-2.5 text-xs text-muted-foreground sm:space-y-3 sm:text-sm w-full">
              <li className="flex items-start gap-2 sm:gap-3 w-full min-w-0">
              ...
              <li className="flex items-start gap-2 sm:gap-3 w-full min-w-0">
                <span className="mt-1 text-accent shrink-0 flex-shrink-0">⚙️</span>
                <span className="break-words min-w-0 flex-1">
          ...
          <div className="rounded-xl border border-blue-200 bg-blue-50/80 p-4 sm:rounded-2xl sm:p-6 w-full min-w-0">
            <p className="text-xs text-blue-900 sm:text-sm break-words w-full">

...
import { Loader2, CheckCircle2, Calendar as CalendarIcon, ArrowRight } from "lucide-react";
...
export function BookingWidget({
    ...
    return (
        <div className="w-full h-full flex items-center justify-center p-4">
            <Card className="w-full max-w-5xl shadow-xl border-zinc-200/60 overflow-hidden flex flex-col md:flex-row min-h-[600px]">
                {/* Left Panel: Info */}
                {variant === "full" && (
                                ...
                                <div className="flex-1 flex justify-center lg:justify-start">
                                    <Calendar
                                        ...
                                        classNames={{
                                            ...
                                            button_previous: "h-8 w-8 bg-transparent p-0 hover:bg-zinc-100 rounded-full transition-colors",
                                            button_next: "h-8 w-8 bg-transparent p-0 hover:bg-zinc-100 rounded-full transition-colors",
                                            weekdays: "flex justify-between w-full mb-2",
                                            weekday: "text-muted-foreground rounded-md w-10 font-medium text-[0.8rem]",
                                            week: "flex w-full mt-2 justify-between",
                                            day_button: "text-center text-sm p-0 relative hover:bg-zinc-100 rounded-full transition-colors focus-within:relative focus-within:z-20",
                                            ...
                                            {timeSlots.map((slot) => (
                                                <Button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        time === slot && "bg-blue-600 text-white hover:bg-blue-700"
                                                    )}
                                                >
                                                    {slot}
                                                </Button>
                        ...
                        <div className="flex flex-col h-full max-w-md mx-auto animate-in fade-in slide-in-from-right-8 duration-500">
                            ...
                            <div className="mt-6">
                                <Button
                                    ...
                                    disabled={!date || !time || !name || !email || !phone || isPending}

  ...
  return (
    <div className={cn("flex flex-col gap-3 pb-4 pt-1 sm:gap-4 sm:pb-6 sm:pt-2 md:flex-row md:items-center md:justify-between w-full min-w-0", className)}>
      <div className="space-y-1 min-w-0 flex-1">
        ...
        {description && <p className="text-balance break-words hyphens-auto text-sm sm:text-base md:text-lg text-muted-foreground text-center sm:text-left">{description}</p>}
      </div>
      {actions && (

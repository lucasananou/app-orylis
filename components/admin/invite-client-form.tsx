...
export function InviteClientForm() {
                ...
                <CardContent className="pt-6 text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-green-600">
                            Le compte est actif et le projet est marqué comme "Livré".
                        </p>
                    </div>
                    <Button
                        variant="outline"
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Inviter un client existant</CardTitle>
                <CardDescription>
                    Crée un compte "Client" avec un projet déjà livré. Idéal pour les anciens clients.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Form

    ...
    <Card className="border border-border/70 bg-white shadow-lg">
      <CardHeader className="pb-4 sm:pb-6 md:pb-8">
        <div className="space-y-1.5 sm:space-y-2">
          <CardTitle className="text-lg sm:text-xl md:text-2xl font-semibold">Votre devis personnalisé – Orylis</CardTitle>
          {formattedDate && (
      ...
      <CardContent className="space-y-4 sm:space-y-6">
        <div className="relative w-full overflow-hidden rounded-lg sm:rounded-xl border border-border/50 bg-muted/5 shadow-md" style={{ minHeight: "400px" }}>
          <iframe
            src={pdfUrl}
